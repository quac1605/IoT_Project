    ...
    def get_frame(self):
        ...
        if(combine_value['lane_number'] == 2):
            if (combine_value['angle'] > 77 and (combine_value['angle'] - (auto_values['angle']/1.2) >= 8) and auto_values['angle'] <= 100):
                ...
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 65 and (combine_value['angle']*1.1 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -65 and (combine_value['angle']*1.1 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 25 and (combine_value['angle']*0.6 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
            ...
            if ((combine_value['angle'] >= 80) and auto_values['angle'] <= 100):
                ...
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 60 and (combine_value['angle']*1.32 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -60 and (combine_value['angle']*1.2 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 48 and (combine_value['angle']*1.36 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -48 and (combine_value['angle']*1.36 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 25 and (combine_value['angle']*1.26 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 4
            elif (combine_value['angle'] <= -25 and (combine_value['angle']*1.26 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 4
            elif (auto_values['angle'] <= 0):
