    ...
    def get_frame(self):
        ...
        if(combine_value['lane_number'] == 2):
            ...
            if ((combine_value['angle'] >= 80) and auto_values['angle'] <= 100):
                ...
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 60 and (combine_value['angle']*1.35 - (auto_values['angle']) >= 5) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 6
            elif (combine_value['angle'] <= -60 and (combine_value['angle']*1.35 - (auto_values['angle']) <= -5) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 6
            elif (combine_value['angle'] >= 38 and (combine_value['angle']*1.25 - (auto_values['angle']) >= 5) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -38 and (combine_value['angle']*1.25 - (auto_values['angle']) <= -5) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 15 and (combine_value['angle']*1.22 - (auto_values['angle']) >= 5) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 4
            elif (combine_value['angle'] <= -15 and (combine_value['angle']*1.22 - (auto_values['angle']) <= -5) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 4
            elif (auto_values['angle'] <= 0):
