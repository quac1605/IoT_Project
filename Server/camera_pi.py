    ...
    def get_frame(self):
        ...
        if(combine_value['lane_number'] == 2):
            ...
            if ((combine_value['angle'] >= 80) and auto_values['angle'] <= 100):
                ...
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 60 and (combine_value['angle']*1.33 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -60 and (combine_value['angle']*1.33 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
            elif (combine_value['angle'] >= 48 and (combine_value['angle']*1.35 - (auto_values['angle']) >= 3) and auto_values['angle'] <= 100):
                auto_values['angle'] = auto_values['angle'] + 8
            elif (combine_value['angle'] <= -48 and (combine_value['angle']*1.35 - (auto_values['angle']) <= -3) and auto_values['angle'] >= -100):
                auto_values['angle'] = auto_values['angle'] - 8
